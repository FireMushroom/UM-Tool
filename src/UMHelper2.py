...
class Ui_MainWindow(object):
    class ItemListPage:
        ...
        def __init__(self, title):        
            ...
            #self.label.setGeometry(QtCore.QRect(185, 0, 150, 30))
            ...
            #self.tableWidget.setGeometry(QtCore.QRect(0, 0, 500, 480))#纵向太长会导致最后一行显示不全
    ...
    class ItemDetailPage:
        ...
        def init_left_table(self):
            ...
            # sizePolicy.setHeightForWidth(self.tableWidget.sizePolicy().hasHeightForWidth())
            # self.tableWidget.setSizePolicy(sizePolicy)
            #self.tableWidget.setMaximumSize(QtCore.QSize(150, 114514))
        ...
        def init_right_info(self):
            ...
            # sizePolicy.setHeightForWidth(self.text_effect.sizePolicy().hasHeightForWidth())
            # self.text_effect.setSizePolicy(sizePolicy)
            ...
            #self.lab_score_content.setScaledContents(True)#自适应控件大小
...
软件目前仍处于早期版本，如<u>遇到bug，或是有功能上的建议，欢迎加QQ交流群:<b>598427123</b></u><br>
更全的攻略资讯请点击查看<a href="https://www.bilibili.com/read/cv14661146">这篇专栏</a><br>
上次更新时间: <i><b>2022.7.31</b></i>""")
        ...
        for i, title in enumerate(page_title):   
            self.page_li.append(Ui_MainWindow.ItemListPage(title))
        ...
        #self.layoutWidget.setGeometry(QtCore.QRect(60, 10, 121, 531))
        ...
        #MainWindow.setAttribute(QtCore.Qt.WA_TranslucentBackground)#窗体背景透明
        MainWindow.setWindowFlags(QtCore.Qt.FramelessWindowHint)#隐藏最大化按钮|QtCore.Qt.FramelessWindowHint
    ...
    def retranslateUi(self, MainWindow):
        ...
        # __sortingEnabled = self.page_info_li[0].tableWidget.isSortingEnabled()
        # self.page_info_li[0].tableWidget.setSortingEnabled(False)
        #设置表格真的左侧表头
        # name_list = ["编号", "稀有度", "解锁方式", "独特圣物", "商店价格", "制作价格", "恶魔房代价", "", "合成材料", ""]
        # for i in range(1, 10):
            # item = self.page_info_li[0].tableWidget.item(i, 0) #忽略第一行图片
            # item.setText(_translate("MainWindow", name_list[i - 1]))
        
        # self.page_info_li[0].tableWidget.setSortingEnabled(__sortingEnabled)
        # self.page_info_li[0].lab_score_content.setText(_translate("MainWindow", "X分"))
        #设置左侧菜单按钮的文本
